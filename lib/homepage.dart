              ...
              children: <Widget>[
                ...
                TextField(
                  decoration: InputDecoration(
                    ...
                    border: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(color: Colors.blue), // Outline color
                    ),
                    filled: true,
                  ...
                  children: <Widget>[
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: _selectedIndex == 0 ? Color.fromARGB(255, 0, 56, 93) : Colors.grey,
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: _selectedIndex == 1 ? Color.fromARGB(255, 0, 56, 93) : Color.fromARGB(108, 0, 56, 93),
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(6),
                        ),
                      ),
                ...
                Expanded(
                  child: _selectedIndex == 0
                      ...
                      : Center(child: Text('Fitur Antar Jemput')),
                ),
              ],
            ),
          ),
